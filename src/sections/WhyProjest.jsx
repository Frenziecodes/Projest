    ...
    <div className="my-10 mx-auto">
      <section className="mb-18 text-gray-800">
        ...
        <section className="my-3 text-center mx-6 md:text-left bg-gradient-to-r from-blue-900 to-violet-500 rounded-md">
              ...
              <div className="flex flex-col md:flex-row items-center">
                <div className="w-full md:w-1/2">
                  <div className="px-6 py-12 md:px-12">
                    <h2 className="mb-6 text-xl lg:text-3xl font-bold text-white">Submit Your Projects with Ease</h2>
                    <p className="mb-6 pb-2 text-white">
                      Showcase your projects by filling out our user-friendly submission form.
                    </p>
                    <div className="">
                      <Link to="addproject" className="py-2 px-6 rounded-md bg-white text-blue-900 font-semibold shadow-lg transition duration-300 ease-in-out hover:bg-blue-800 hover:text-white">
                        Add Project
                      </Link>
                    </div>
                  </div>
          ...
          <section className="my-6 mx-6 text-center md:text-left bg-gradient-to-l from-blue-900 to-violet-500 rounded-md">
            <div className="block rounded-lg">
              <div className="flex flex-col md:flex-row items-center">
                <div className="flex justify-center items-center w-full md:w-1/2 p-6">
                  <img
                ...
                <div className="w-full md:w-1/2">
                  <div className="px-6 py-12 md:px-12">
                    <h2 className="mb-6 text-xl lg:text-3xl font-bold md:text-right text-white">Explore Exciting Projects</h2>
                    ...
                    <div className="flex justify-center md:justify-end">
                      <Link to="viewprojects" className="py-2 px-6 rounded-md bg-white text-blue-900 font-semibold shadow-lg transition duration-300 ease-in-out hover:bg-blue-800 hover:text-white">
                        Explore Projects
                      </Link>
                    </div>
                  </div>
