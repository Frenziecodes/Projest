...
function AdvertBanner() {
  ...
  return (
    <div className="alert alert-dismissible fade show items-center justify-between rounded-sm mb-1 bg-blue-800 py-4 px-6 text-center text-white md:flex md:text-left">
