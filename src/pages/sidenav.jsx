...
const SideNav = () => {
  ...
  return (
    <div className='fixed left-0 top-0' id='mySidenav'>       
    ...
    <div className='relative'>
      ...
      {isOpen && (
        ...
        <li className='relative flex items-center text-center text-2xl mb-4 py-4 px-8 h-12 overflow-hidden  text-ellipsis whitespace-nowrap rounded transition duration-300 ease-in-out text-blue-600' data-mdb-ripple="true" data-mdb-ripple-color="dark">
              PROJEST
        </li>     
