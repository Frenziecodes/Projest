  ...
  return (
    <div>
      ...
      {scrollTop > 90 && <button
        ...
        className="inline-block p-3 m-3 fixed right-2 bg-blue-400 z-10 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out bottom-5 btn_up" id="btn-back-to-top">
