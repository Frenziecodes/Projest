...
function DocsPage() {
  return (
    <div>
      <section className="mt-16 md:flex md:justify-between md:items-start md:w-full">
        <div className="flex justify-center flex-col p-4">
          ...
          4.Fill in the form with your project details, including the project
          title, description, user Github link, and project Github link. <br />
          5.Select the tags that best describe your project. <br />
          6.Click the "Submit" button to send the form data to the real-time
        ...
        <div className="flex justify-center flex-col p-4">
          ...
          4.All the projects that have been submitted to the platform will be
          displayed. <br />
          5.You can search for a specific project by its title or tag name using
          the search bar. <br />
        </div>
        ...
        <div className="flex justify-center flex-col p-4">
          ...
          4.Follow the project's Github link to access its repository. 5.Make
          your contributions to the project. <br />
        ...
        <div className="md:flex md:flex-row md:w-full md:my-2 md:justify-between md:items-start">
          <div className="md:flex md:flex-col md:w-full md:my-2 md:justify-between md:items-start">
            <div className="flex justify-center flex-col p-4 md:w-full md:mb-1 md:p-2">
              ...
              "Projest" is a platform that allows users to upload and view
            ...
            <div className="flex justify-center flex-col p-4 md:p-2">
              ...
              Add the Firebase SDK to your project. Connect to the Firebase
              database and retrieve the project data. Display the project data
              in your desired format. Implement the search functionality to
              allow users to search for projects by title or tag.
            </div>
          </div>
          ...
          <div className="md:flex md:flex-col md:w-full md:my-2 md:justify-between md:items-start">
            <div className="flex justify-center flex-col p-4 md:w-full">
              ...
              /api/projects: Returns a list of all projects stored in the
              Firebase database.
              <br />
            ...
            <div className="flex justify-center flex-col p-4">
              ...
              Ensure that you comply with Firebase's terms of service and
              privacy policy when using their database. Do not store sensitive
              information in the Firebase database. Handle errors and exceptions
          ...
          <div className="flex justify-center flex-col p-4 md:w-full">
            ...
            The data format for projects is as follows:
            <div className="flex justify-center items-center p-2 mt-4 bg-slate-300 rounded-md">
              ...
              <br />
              "userGithubLink": "link to user's Github profile",
              <br />
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            <div className="md:mb-12">
              ...
              <p className="text-gray-500">
                Projest is a platform where users can upload their Github
            ...
            <div className="md:mb-12">
              ...
              <p className="text-gray-500">
                To add a project to Projest, go to the "Add Project" page and
                fill out the form with your project's details such as the title,
                description, and Github links. Then click on the submit button
                to save the project.
              </p>
            </div>
            ...
            <div className="md:mb-12">
              ...
              <p className="text-gray-500">
                Yes, you can add multiple projects to Projest. Each project will
                be saved as a separate entry in the database.
              </p>
            </div>
            ...
            <div className="col-md-12 md:mb-12">
              ...
              <p className="text-gray-500">
                To view all the projects on Projest, go to the "View Projects"
                page. All the projects will be listed there.
              </p>
            </div>
            ...
            <div className="md:mb-12">
              ...
              <p className="text-gray-500">
                Yes, you can search for specific projects on Projest by using
                the search functionality tool. You can search by the project
                title or tag name.
              </p>
            </div>
            ...
            <div className="md:mb-12">
              ...
              <p className="text-gray-500">
                Currently, Projest does not have the functionality to edit or
                delete projects.
              </p>
            </div>
          </div>
